...
function displayProfileContent(userRole) {
    ...
    if (userRole === 'buyer') {
        profileContent.innerHTML = '<h2>Welcome, Buyer!</h2><p>Your profile content for buyers goes here.</p>';
    } else if (userRole === 'seller') {
        profileContent.innerHTML = '<h2>Welcome, Seller!</h2><p>Your profile content for sellers goes here.</p>';
    } else if (userRole === 'renter') {
        profileContent.innerHTML = '<h2>Welcome, Renter!</h2><p>Your profile content for renters goes here.</p>';
    } else {
